 ...
 * @package    SynergyGearman
 * @subpackage SynergyGearman\Worker
 */
...
use SynergyGearman\Job\Pecl as PeclJob;
use SynergyGearman\WorkerInterface;
...
class Pecl extends AbstractPecl implements WorkerInterface
{
    ...
    public function connect()
    {
        ...
        foreach ($this->functions as $f) {
            $client->register($f, $this->timeout);
        }
    ...
    public function register($name, $func)
    {
        ...
        if (!isset($this->functions[$name])) {
            ...
            if ($this->isConnected) {
                $this->getGearmanWorker()->register($name, $this->timeout);
    ...
    public function unregister($name)
    {
        if (isset($this->functions[$name])) {
            ...
            if ($this->isConnected) {
                $this->getGearmanWorker()->unregister($name);
            }
        }
        return $this;
    }
